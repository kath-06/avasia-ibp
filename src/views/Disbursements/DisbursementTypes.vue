  ...
  <div> 
    ...
    <div class="col-12 container-fluid mt--7" >
      <tabs fill class="flex-column flex-md-row">
        <!-- Cash disbursement type tab -->
        <tab-pane title="Cash Disbursement Type">
          <cash-disbursement-type></cash-disbursement-type>
        </tab-pane>
        <!-- Remittance disbursement type tab -->
        <tab-pane title="Remittance Disbursement Type">
          <remittance-disbursement-type></remittance-disbursement-type>
        </tab-pane>
      </tabs>
    </div>
  </div>
